...
| S-05       | `live-tally-and-outcome`       | Bilans udziałów na żywo i automatyczne rozstrzygnięcie uchwały             | yes                   | `S-03` zamknięte 2026-08-03, więc odblokowane. Czyta migawkę `votes.share_bps`, nie przelicza udziałów. `opened_at` pochodzi z zegara Workera — patrz **Unknowns** przy `S-05`                    |
