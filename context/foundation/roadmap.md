...
| F-02 | `transactional-mail-channel`| (fundament) z Workera wychodzi jedna prawdziwa wiadomość, przez natywny binding Cloudflare, z własnej domeny                | —             | FR-002, FR-004               | ready    |
...
| F-02       | `transactional-mail-channel`   | Podłączyć Cloudflare Email Service i wysłać pierwszą wiadomość z Workera   | yes                   | Uruchom `/10x-plan transactional-mail-channel`. Ręczne warunki wstępne: zakup domeny, plan Workers Paid |
